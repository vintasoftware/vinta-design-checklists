...
## 2. Running the test
* [ ] Preferably let participants use their own devices (cell phones or computers). 
...
* [ ] If the participant struggles with an interaction, don't explain why you designed it that way. Focus on collecting useful insights. 
* [ ] After participants have performed the action, ask them for feedback related to the feature. Let them speak freely and be careful with biasing them for a specific answer.
